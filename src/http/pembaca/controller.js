...
const { tambahPembaca, tampilPembaca, ubahPembaca, hapusPembaca, byId} = require("./service.js");
...
const createPembaca = async (req, res) => {
    try {
        ...
        return resSukses(res, 201, "success", "Data pembaca berhasil ditambahkan", data);
    } catch (error) {
        return resGagal(res, 500, "error", error.message);
    }
};
...
const deletePembaca = async (req, res) => {
    try {
        ...
        return resSukses(res, 201, "success", "Data pembaca berhasil dihapus", data);
    } catch (error) {
        return resGagal(res, 500, "error", error.message);
    }
};
